...
\setlist[description]{leftmargin=0em, itemsep=0.2em, topsep=0.25em, style=nextline}
\titlespacing*{\section}{0pt}{0.6em}{0.3em}
\titleformat{\section}{\large\bfseries}{}{0pt}{}
\pagestyle{empty}
\urlstyle{same}

\newcommand{\sectionrule}{\vspace{-0.45em}\hrule\vspace{0.35em}}
\newcommand{\entry}[4]{%
  \textbf{#1} \hfill #2\\
  \textit{#3}\\
  #4\vspace{0.35em}
...
\entry{Lawrence Livermore National Laboratory}{Dec 2018 -- Present}{Machine Learning Research Scientist, Machine Learning Group}{
\begin{itemize}
  ...
  \item Develop methods for antibody developability prediction, in silico library design, and computational protein optimization for therapeutic and biomaterials applications.
  \item Train and adapt billion-parameter clinical foundation models on structured event sequences at hundred-GPU scale for biosurveillance, infectious disease detection, diagnosis prediction, and drug repurposing.
...
\entry{Center for Research and Development in Telecommunication (CPqD)}{Oct 2017 -- Nov 2018}{Postdoctoral Researcher}{
\begin{itemize}
  \item Developed voice biometrics and presentation-attack detection models using spectral, temporal, and convolutional approaches.
...
\entry{University of Minnesota, Twin Cities}{Apr 2015 -- Aug 2017}{Research Staff}{
\begin{itemize}
  \item Developed sparse and structural multitask learning methods for high-dimensional prediction problems in climate science and biomedical data.
  \item Published work on multitask learning, structured estimation, and Earth system modeling in venues including \textit{JMLR}, \textit{Computing in Science \& Engineering}, \textit{AAAI}, and \textit{CIKM}.
\end{itemize}}

\entry{Earlier Research Appointments}{Mar 2009 -- Oct 2014}{Research Assistant roles at University of Campinas and Brazilian Agricultural Research Corporation (Embrapa)}{
\begin{itemize}
  \item Worked on dynamic optimization, estimation of distribution algorithms, and early machine learning applications in bioinformatics and health data.
  \item Started doing machine learning research during undergraduate studies after joining a faculty research lab in the second year of the program.
\end{itemize}}
...
\sectionrule
\begin{itemize}
  \item Director's Science and Technology Award recipient and Director's Award in Publication recipient, Lawrence Livermore National Laboratory, 2022.
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item Pan, B., Anderson, G. J., \textbf{Goncalves, A. R.}, Lucas, D. D., Bonfils, C. J. W., Lee, J., Tian, Y., et al. Learning to correct climate projection biases. \textit{Journal of Advances in Modeling Earth Systems}, 2021.
\end{itemize}
...
\sectionrule
Reviewer or program committee member for venues including TKDE, AAAI, SDM, \textit{npj Digital Medicine}, \textit{PLOS ONE}, \textit{BMC Medical Research Methodology}, and \textit{IEEE Sensors Journal}. Co-inventor on Brazilian patent BR 10 2015 017556-6, automatic voice liveness detection system.
