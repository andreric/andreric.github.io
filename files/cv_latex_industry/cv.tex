...
\begin{document}
	...
	\entry{Lawrence Livermore National Laboratory}{Oct 2017 -- Present}{Machine Learning Research Scientist, Machine Learning Group}{
		\begin{itemize}
			...
			\item Train and adapt billion-parameter clinical foundation models on structured event sequences at hundred-GPU scale for biosurveillance, infectious disease detection, and diagnosis prediction, and developed causal ML methods for drug repurposing in ALS.
